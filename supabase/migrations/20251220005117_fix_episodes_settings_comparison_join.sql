/*
  # Fix Episodes Settings Comparison Function

  ## Problem
  The function references e.program_length_minutes and e.format_type but those columns
  are on the scripts table, not episodes table. This causes the sync modal to show
  "No other X-minute episodes" even when matching episodes exist.

  ## Solution
  Join to scripts table to get program_length_minutes and format_type
*/
