/*
  ...
  ## Problem
  The delete_series function references character_aliases table which doesn't exist.
  
  ## Solution
  Remove the DELETE statement for character_aliases and any other non-existent tables.
*/
...
BEGIN
  ...
  -- REMOVED: character_aliases table doesn't exist
