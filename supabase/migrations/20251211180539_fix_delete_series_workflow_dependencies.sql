...
BEGIN
  ...
  DELETE FROM template_installations WHERE series_id = series_uuid;
  DELETE FROM shared_asset_pools WHERE source_series_id = series_uuid OR target_series_id = series_uuid;
