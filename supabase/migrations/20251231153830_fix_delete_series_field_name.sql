/*
  # Fix delete_series Function - Correct Field Name

  ## Problem
  The delete_series function references series_record.title but the series table 
  uses 'name' field, causing deletion failures.
  
  ## Solution
  Update all references from series_record.title to series_record.name
*/
