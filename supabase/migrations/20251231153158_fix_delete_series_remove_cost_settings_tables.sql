/*
  # Fix delete_series Function - Remove Non-existent Cost Settings Tables

  ## Problem
  The delete_series function references creator_cost_settings and production_cost_settings 
  tables which don't exist in the database.
  
  ## Solution
  Remove DELETE statements for these non-existent tables.
*/
...
BEGIN
  ...
  -- Delete series-level data (only tables that actually exist)
  ...
  -- REMOVED: creator_cost_settings and production_cost_settings don't exist
