/*
  # Fix delete_series Function - Use 'name' Column Instead of 'title'

  ## Changes
  - Changed series_record.title to series_record.name (correct column name)
  - Updated both the audit log and return statement
*/
