/*
  # Fix delete_series Function - Correct brand_comparison_snapshots Column Reference

  ## Problem
  The brand_comparison_snapshots table uses 'series_ids' (array) not 'series_id' (single value).
  
  ## Solution
  Update DELETE statement to check if the series_uuid exists in the series_ids array using the ANY operator.
*/
...
BEGIN
  ...
  -- FIXED: brand_comparison_snapshots uses series_ids (array) not series_id
