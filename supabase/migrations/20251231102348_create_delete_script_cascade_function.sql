/*
  # Create Cascading Script Delete Function

  ## Purpose
  Provides a function to delete a script along with all its dependent data,
  including episodes and their related content. This mirrors the pattern used
  in delete_series for comprehensive cleanup.

  ## What Gets Deleted
  1. Script-related data:
     - Script translations
     - Voice recordings (via scenes)
     - Scene shots
     - Script scenes
     - Script act translations
     - Script acts
     - Script locks
     - Script history

  2. Episode-related data (for episodes linked to this script):
  ...
  3. Storyboard data (linked to script):
     - Storyboard character references
     - Storyboard image versions
     - Storyboard shot edits
     - Storyboard shots
     - Storyboard revisions
     - Storyboards

  4. Finally, the script itself

  ## Security
  - SECURITY DEFINER ensures proper permissions
  - User must be a member of the organization that owns the script
