/*
  # Fix delete_series Function - Correct All Column Names

  ## Fixed Columns
  - template_installations uses 'installed_series_id' not 'target_series_id'
  - brand_comparison_snapshots uses 'series_ids' (array) not 'series_id'
  
  ## Verified Correct Columns
  - asset_transformations: target_series_id ✓
  - asset_usage_tracking: used_in_series_id ✓
  - quality_gates: series_id ✓
  - brand_analytics: series_id ✓
  - cost_efficiency_metrics: series_id ✓
  - asset_recommendations: series_id ✓
  - production_cost_config: series_id ✓
*/
...
BEGIN
  ...
  -- Delete production jobs (uses entity_type and entity_id)
  ...
  -- Delete asset-related data for this series
  ...
  -- brand_comparison_snapshots uses series_ids (array)
  ...
  -- FIXED: template_installations uses 'installed_series_id' not 'target_series_id'
