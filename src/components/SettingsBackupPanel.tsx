...
import { Database, Shield, Clock, AlertTriangle, Info, CheckCircle, History, Download, RefreshCw, Archive, Activity } from 'lucide-react';
                            ...
                            {check.issues_found && check.issues_found.length > 0 && (
                              <div className="bg-red-50 border border-red-200 rounded p-3 mb-2">
                                ...
                                <ul className="text-sm text-red-700 space-y-1">
                                  {check.issues_found.map((issue: any, idx: number) => (
                                    <li key={idx}>
