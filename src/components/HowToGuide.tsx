...
const sections: Section[] = [
  ...
  {
    id: 'assembly',
    title: 'Assembly & Editing (Shotstack)',
    icon: '✂️',
    content: [
      'The Assembly step uses Shotstack — a cloud video editing API — to automatically combine all rendered shots into a complete episode rough cut.',
      '',
      'Before You Begin:',
      '• You need a Shotstack API key. Sign up at shotstack.io (a free sandbox tier is available for testing — output will be watermarked).',
      '• Add your API key via Settings > Assembly / Editing, or directly inside the Assembly panel settings drawer.',
      '',
      'How Assembly Works:',
      '• The platform picks the best available video for each shot: lipsync render → Veo3 render → still image fallback',
      '• A Shotstack timeline is built automatically with video clips, dialogue audio, transitions, and optional slate/end-card',
      '• The timeline is submitted to Shotstack\'s cloud render API',
      '• Status is polled every 8 seconds; the finished video URL is stored when complete',
      '',
      'Triggering an Assembly:',
      '1. Navigate to a production and go to the Assembly step (after Batches)',
      '2. Assembly triggers automatically when ≥80% of shots are complete',
      '3. Or click "Assemble Rough Cut" in the Batches step footer at any time',
      '',
      'Assembly Panel Settings:',
      '• Transition type: Cut, fade, or dissolve between shots',
      '• Resolution: 720p, 1080p, or 4K output',
      '• Frame rate: 24, 30, or 60 fps',
      '• Dialogue volume: Mix level for character audio tracks',
      '• Background music: Paste a URL to add a music bed',
      '• Slate / end-card: Toggle to auto-prepend or append a title card',
      '• API key: Enter your Shotstack Stage or Production key here',
      '',
      'After Assembly:',
      '• A progress bar shows live render status',
      '• When complete, preview the rough cut inline or download it',
      '• Previous assembly versions are listed below the player',
      '• Render typically takes 1–5 minutes depending on episode length',
      '',
      'Pricing Notes:',
      '• Sandbox renders are free but watermarked — use for testing and approvals',
      '• Production tier: ~$0.05–$0.20 per rendered minute',
      '• See shotstack.io/pricing for current rates',
      '',
      'Quick Reference:',
      'Settings > Assembly / Editing  →  Add Shotstack API key',
      'Production > Assembly step  →  Settings drawer  →  Configure transitions, resolution, music',
      'Production > Batches step  →  "Assemble Rough Cut" button  →  Trigger manually'
    ]
  },
  {
