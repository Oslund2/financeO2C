...
const sections: Section[] = [
  ...
  {
    id: 'assembly',
    title: 'Assembly & Editing',
    icon: '✂️',
    content: [
      'The Assembly step combines rendered shots into a complete episode rough cut using Shotstack\'s cloud video API.',
      '',
      'Getting Started:',
      '• Sign up at shotstack.io and get an API key (free sandbox tier available)',
      '• Add the key via the Assembly settings drawer in any production, or set VITE_SHOTSTACK_API_KEY in your environment',
      '',
      'How It Works:',
      '• The platform selects the best video for each shot: lipsync render, Veo3 render, or still image fallback',
      '• A timeline is built with clips, dialogue audio, transitions, and optional slate/end-card',
      '• Assembly triggers automatically at 80% shot completion, or click "Assemble Rough Cut" manually',
      '• Renders take 1-5 minutes; preview or download when complete',
      '',
      'Settings: transition type, resolution, frame rate, dialogue volume, background music, and slate/end-card are all configurable in the Assembly panel.'
    ]
  },
  {
