            ...
            <div className="p-8">
              <div className="max-w-2xl mx-auto text-center">
                <div className="bg-white rounded-xl shadow-md p-12 border border-gray-200">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">No Storyboard Selected</h3>
                  <p className="text-gray-600 mb-6">Please select a script and generate or view its storyboard from the Storyboard Generator.</p>
                  <button
                    onClick={() => handleNavigate('storyboard-generator')}
